...
```
           ...
           1       0.97      0.98      0.97    628860
           2       0.90      0.94      0.92    141483
           3       0.86      0.73      0.79     51573
           4       0.82      0.78      0.80      3016
           5       0.83      0.83      0.83      6168
           6       0.95      0.94      0.94    180000
           7       0.75      0.78      0.77       370

   micro avg       0.95      0.95      0.95   1020469
   macro avg       0.89      0.87      0.88   1020469
weighted avg       0.95      0.95      0.95   1020469

```


24. v3 data, confusion experiments with 5xBiLSTM horizontal + BiLSTM(128) + Dense(softmax), adam, 50,000 max class:
 - 28 classes: 0.57 f1
 - 10 classes (convusion envs), v1: 0.842 f1, v2: 0.867
 - 8 classes (stricter envs v3): 0.926 f1
 - 8 classes (confusion envs v3): 0.918 f1
 
 25. v3 data, BLSTM(8: 16 : 32 : 64 : 128) + BLSTM(128) + Dense(8, softmax), adam, 0.95m max class
 ```

               precision    recall  f1-score   support

           0       1.00      1.00      1.00      9000
           2       0.97      0.98      0.97    670060
           1       0.95      0.93      0.94    192296
           3       0.93      0.92      0.92    141483
           6       0.85      0.83      0.84      6168
           5       0.85      0.79      0.82      3016
           4       0.84      0.74      0.79     51573
           7       0.82      0.76      0.79       370

   micro avg       0.95      0.95      0.95   1073966
   macro avg       0.90      0.87      0.88   1073966
weighted avg       0.95      0.95      0.95   1073966

```

26. flat BiLSTM(128) + Dense(8), data as in 25
```
           0       0.99      1.00      1.00      9000
           2       0.96      0.98      0.97    670060
           1       0.95      0.92      0.93    192296
           3       0.91      0.91      0.91    141483
           6       0.80      0.79      0.79      6168
           4       0.83      0.70      0.76     51573
           5       0.84      0.72      0.77      3016
           7       0.78      0.69      0.73       370

   micro avg       0.94      0.94      0.94   1073966
   macro avg       0.88      0.84      0.86   1073966
weighted avg       0.94      0.94      0.94   1073966

```

26. BiLSTM(128) + BiLSTM(64) + Dense(8), data as in 25
           0       1.00      1.00      1.00      9000
           2       0.96      0.98      0.97    670060
           1       0.95      0.93      0.94    192296
           3       0.93      0.91      0.92    141483
           6       0.85      0.80      0.82      6168
           5       0.81      0.79      0.80      3016
           4       0.84      0.72      0.78     51573
           7       0.82      0.72      0.77       370

   micro avg       0.95      0.95      0.95   1073966
   macro avg       0.89      0.86      0.87   1073966
weighted avg       0.95      0.95      0.95   1073966

27. Deep logistic regression (500), data as in 25
```
Layer (type)                 Output Shape              Param #   
=================================================================
embedding_1 (Embedding)      (None, 480, 300)          300089400 
...
_________________________________________________________________
dense_1 (Dense)              (None, 500)               72000500  
_________________________________________________________________
...
=================================================================
Total params: 373,403,408
Trainable params: 73,314,008
Non-trainable params: 300,089,400

1073966/1073966 [==============================] - 37s 35us/step
              precision    recall  f1-score   support

           0       1.00      0.99      0.99      9000
           1       0.89      0.81      0.84    192296
           2       0.85      0.97      0.91    670060
           3       0.83      0.56      0.67    141483
           4       0.74      0.40      0.52     51573
           5       0.76      0.59      0.66      3016
           6       0.87      0.36      0.51      6168
           7       0.57      0.52      0.54       370

   micro avg       0.85      0.85      0.85   1073966
   macro avg       0.81      0.65      0.71   1073966
weighted avg       0.85      0.85      0.84   1073966
