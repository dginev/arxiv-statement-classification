...
bilstm_0 = Bidirectional(
    CuDNNLSTM(layer_size // 16))(embedding_layer)
if use_dropout:
    bilstm_0 = Dropout(0.1)(bilstm_0)

bilstm_1 = Bidirectional(
    CuDNNLSTM(layer_size // 8))(embedding_layer)
if use_dropout:
    bilstm_1 = Dropout(0.1)(bilstm_1)

# level_1 = concatenate([bilstm_1, embedding_layer, bilstm_1], axis=0)
level_1 = embedding_layer

bilstm_2 = Bidirectional(
    CuDNNLSTM(layer_size // 4))(level_1)
if use_dropout:
    bilstm_2 = Dropout(0.1)(bilstm_2)

# level_2 = concatenate([bilstm_2, embedding_layer, bilstm_2], axis=0)
level_2 = embedding_layer

bilstm_3 = Bidirectional(
    CuDNNLSTM(layer_size // 2))(level_2)
if use_dropout:
    bilstm_3 = Dropout(0.1)(bilstm_3)

# level_3 = concatenate([bilstm_3, embedding_layer, bilstm_3], axis=0)
level_3 = embedding_layer

bilstm_4 = Bidirectional(
    CuDNNLSTM(layer_size))(level_3)
if use_dropout:
    bilstm_4 = Dropout(0.1)(bilstm_4)

level_4 = concatenate([bilstm_0, bilstm_1, bilstm_2, bilstm_3, bilstm_4])

output = Dense(n_classes, activation='softmax')(level_4)
